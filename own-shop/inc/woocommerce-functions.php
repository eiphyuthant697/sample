...
function own_shop_woocommerce_cart_link() {
    ...
    $cart_text = esc_html(get_theme_mod('own_shop_header_menucart_text',esc_html__('Cart','own-shop'))) ;
    ?>
    ...
    <div class="search-form-wrapper">
        <form role="search" method="get" class="woocommerce-product-search" action="<?php echo esc_url(home_url('/')); ?>">
            <div class="form-group search">
                ...
                <div class="search-form"><i class="la la-search" aria-hidden="true"></i> <input type="search" id="woocommerce-product-search-field" class="search-field"   placeholder="<?php echo esc_attr($search_placeholder); ?>" value="<?php echo get_search_query(); ?>" name="s"/></div>
                <!-- <?php
