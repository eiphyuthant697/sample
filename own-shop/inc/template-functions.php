                        ...
                        if("" != esc_html(get_theme_mod( 'own_shop_footer_copyright_text'))) :
                            ...
                            ?>
                                ...
                                <span> All Rights Served
                                    <?php //esc_html_e(' | Theme by ','own-shop') ?><a href="<?php //echo esc_url(OWN_SHOP_THEME_AUTH); ?>" target="_blank"><?php //esc_html_e('Spiracle Themes','own-shop') ?></a>
                                </span>
                            <?php
                        endif;
                    ?>
...
function own_shop_enable_header_topbar_style1() {
    ?>  
        <div class="top-bar">
            <div class="<?php echo esc_attr(OWN_SHOP_CONTAINER_CLASS) ?> con_width">
                <div class="row">
