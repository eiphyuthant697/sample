...
<div id="service-single-content d-flex" class="single-service">
  <div class="service-cntl">
                  ...
                  <?php the_field('sdescription'); ?>
					...
					<?php if(get_field('quotation')): ?>
						<div class="quotation-link">
							<a class="q-link" target="_blank" href="<?php the_field('quotation'); ?>"><span></span><span></span><span></span><span></span>Quotation</a>
						</div>
					<?php endif; ?>
                        ...
                        <ul class="other-service-posts">
                          <?php foreach( $other_posts as $other_post ): 
                            ...
                            <li class="other-service-post">
                              <a href="<?php echo esc_url( $permalink ); ?>"><span></span><span></span><span></span><span></span><?php echo esc_html( $title ); ?></a>
