	...
	$.fn.fbuilder = function(options) {
	    ...
	    var reloadItemsPublic = function() {
	        ...
	        if (page > 0) {
	            ...
	            $("#fieldlist" + opt.identifier + " .pbreak").each(function(index) {
	                ...
	                if (index == page) {
	                    ...
	                    if ($("#cp_subbtn" + opt.identifier).html()) {
	                        bSubmit = '<div class="modal-dab"><div class="pbSubmit">' + $("#cp_subbtn" + opt.identifier).html() + '</div></div>';
	                    }
	                }
	            ...
	            if ($("#cp_subbtn" + opt.identifier).html()) {
	                $("#fieldlist" + opt.identifier + " .pb" + page).append('<div class="accept_submit modal" id="modal"><div class="modalcontent accept"><h2><span>Privacy Policy</span><button type="button" class="close" id="close_btn" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></h2><p>Suggested text: When visitors leave comments on the site we collect the data shown in the comments form, and also the visitor’s IP address and browser user agent string to help spam detection.An anonymized string created from your email address(also called a hash) may be provided to the Gravatar service to see if you are using it.The Gravatar service privacy policy is available here: https: //automattic.com/privacy/. After approval of your comment, your profile picture is visible to the public in the context of your comment.</p><div class="agree_to"><input type="checkbox" name="agree_to" id="agree_to" class="agree_to-checkbox" required><span> I agree to Privacy Policy of UK Cargo.</span></div><div class="pbSubmit">' + $("#cp_subbtn" + opt.identifier).html() + '</div> </div></div>');
	            }
	        }
