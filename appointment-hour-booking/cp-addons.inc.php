...
<div class="ahb-addons-container ahb-disabled-addons">
	...
	<div class="ahb-addons-group">
		...
		<div class="ahb-addon">
			<label><input type="checkbox" disabled>Razorpay</label>
			<p>The add-on adds support for Razorpay.com payments</p>
		</div>        
		<div class="ahb-addon">
...
<div class="ahb-addons-container ahb-disabled-addons">
	...
	<div class="ahb-addons-group">
		...
		<div class="ahb-addon">
			<label><input type="checkbox" disabled>Integration with Calculated Fields Form plugin</label>
			<p>The add-on adds offers integration with the <a href="https://cff.dwbooster.com/" target="_blank">Calculated Fields Form</a> plugin (requires Calculated Fields Form Platinum version)</p>
		</div>
	</div>
</div>
<div class="ahb-to-top"><a href="#top">&uarr; Top</a></div>
...
<div class="ahb-addons-container ahb-disabled-addons">
	...
	<div class="ahb-addons-group">
		...
		<div class="ahb-addon">
			<label><input type="checkbox" disabled>Calendar Admin in Frontend</label>
			<p>Shortcode to admin the calendar assigned to the logged in user in the frontend.</p>
		</div>
		<div class="ahb-addon">
        ...
        <div class="ahb-addon">
            <label><input type="checkbox" disabled>Additional Booking Statuses</label>
            <p>The add-on allows to add new statuses to the bookings</p>
        </div>           
        <div class="ahb-addon">
        ...
        <div class="ahb-addon">
			<label><input type="checkbox" disabled>User Registration</label>
			<p>Creates a WordPress user account upon submission</p>
		</div>
	</div>
</div>
<div class="ahb-to-top"><a href="#top">&uarr; Top</a></div>
...
<div class="ahb-addons-container ahb-disabled-addons">
	...
	<div class="ahb-addons-group">
		...
		<div class="ahb-addon">
			<label><input type="checkbox" disabled>Text-Em-All SMS Text Messaging & Automated Calling</label>
			<p>The add-on adds support for Text-Em-All SMS notifications</p>
		</div>           
	</div>
</div>
