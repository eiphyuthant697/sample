			...
			<script type="text/javascript">
				...
				jQuery(document).ready(function() {
					...
					var $productWrapper = jQuery('.post-<?php echo $product->get_id(); ?>').first(),
						$customizeButton = jQuery('.fpd-modal-mode-btn');
					...
					.on('show_variation', function(evt, variation) {
						...
						jQuery('.fpd-variation-needed #customize_modal_btn').css('display','block');
					...
					.on('reset_data', function() {
						...
						if($productWrapper.hasClass('fpd-variation-needed')) {
							...
							//jQuery('#customizeButton').css('display','none');

						}

					});

					jQuery("#customize_modal_btn").on("click",function(){
						jQuery("#modal_customize").css({'display':'block', 'z-index':'10'});
					  //document.querySelector(".fields").style.display = 'none';

					})
					jQuery("#category_product_modal_box").css("display","none");
					jQuery("#category_product_modal").on("click",function(){
						jQuery("#modal_customize").css({'display':'none', 'z-index':'0'});
						jQuery("#category_product_modal_box").css({'display':'block', 'z-index':'11'});

					})
					jQuery("#customer_product_modal_box").css("display","none");
					jQuery(".fpd-itemCP").css("display","none");
					jQuery("#customer_product_modal").on("click",function(){
						jQuery("#modal_customize").css({'display':'none', 'z-index':'0'});
						jQuery("#customer_product_modal_box").css({'display':'block', 'z-index':'11'});
