...
class Real_Home_Customize_Repeater_Control extends WP_Customize_Control {
    ...
    public function enqueue() {
        ...
        wp_enqueue_script( 'repeater', get_template_directory_uri(). '/inc/repeater.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-sortable' ), false, true );
        wp_enqueue_style( 'repeater', get_template_directory_uri() . '/inc/repeater.css', null );
