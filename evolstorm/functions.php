...
function foodica_enqueue_scripts() {
    ...
    // wp_enqueue_style( 'foodica-style-bootstrap', get_template_directory_uri() . '/assets/css/bootstrap.min.css', array( 'foodica-style' ), '4.3.1' );
    ...
    wp_enqueue_script( 'library', get_template_directory_uri() . '/assets/js/libs.js');
