						...
						<div class="cat-inner">                       
							<div class="item-img custom_cat">                          
								...
								<a href="<?php the_permalink(); ?>">
									<img src="<?php echo $image_cat; ?>" alt="blog">
								</a>                       
							</div>                       
							<div class="item-content">                          
								<ul class="entry-meta meta-color-dark">                             
									<li>
										<i class="fas fa-tag"></i><?php echo get_cat_name($catID); ?>
									</li>                          
								</ul>                          
								<h3 class="item-title">
									<a href="<?php the_permalink(); ?>">
										<?php short_title(get_theme_mod('title_limit', '60')); ?>
									</a>                          
								</h3>                          
								<p><?php short_content(get_theme_mod('content_limit', '200')); ?></p>                          
								<div class="action-area">                             
									<a href="<?php the_permalink(); ?>" class="item-btn">
										<?php echo get_theme_mod('blog_button_text', 'つづきを読む'); ?>
