    ...
    <div class="container">
        <div class="calltoaction_full_widget_content">
            ...
            <div class="calltoaction_button_wrap">
                <?php if($btn): ?>
                    <a href="<?php echo esc_url($btn_link); ?>" class="btn btn-primary"> <?php echo esc_html($btn); ?></a>
                <?php endif; ?>
                <?php if($btn1): ?>
                    <a href="<?php echo esc_url($btn_link1); ?>" class="btn btn-border"> <?php echo esc_html($btn1); ?></a>
                <?php endif; ?>
            </div>
            <?php endif; ?>
        </div>
