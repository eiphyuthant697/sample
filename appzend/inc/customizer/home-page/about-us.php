<?php
	...
	*/
	$wp_customize->add_section(new AppZend_Toggle_Section($wp_customize, 'appzend_aboutus_section', array(
		...
		$wp_customize->selective_refresh->add_partial( 'appzend_aboutus', array(
            'selector'        => '#aboutus',
        ) );
		
		$wp_customize->selective_refresh->add_partial( 'appzend_aboutus_super_title', array(
            'selector'        => '#aboutus .headlines h4'
        ) );


		$wp_customize->selective_refresh->add_partial( 'appzend_aboutus_title', array(
            'selector'        => '#aboutus .headlines h2'
        ));

		$wp_customize->selective_refresh->add_partial( 'appzend_aboutus', array(
            'selector'        => '#aboutus .section-box'
        ));