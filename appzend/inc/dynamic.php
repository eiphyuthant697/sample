...
if (! function_exists('appzend_dynamic_css')){
	...
	function appzend_dynamic_css(){
        ...
        // button color 
        $btn_bg = get_theme_mod('appzend_button_bg_color');
        $btn_text = get_theme_mod('appzend_button_text_color');
        $btn_hov_bg = get_theme_mod('appzend_button_bg_hov_color');
        $btn_hov_text = get_theme_mod('appzend_button_text_hov_color');
        ...
        */
        ...
        foreach($dynamic_sections as $section => $parent):
            ...
            if($title_color){
                $appzend_dynamic .= " {$parent} .section-box .box-title{ color: $title_color }";
            }
            if($text_color){
