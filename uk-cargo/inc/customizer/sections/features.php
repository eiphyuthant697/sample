...
$wp_customize->add_setting( 'theme_options[feature_category]',
	array(
	'capability'        => 'edit_theme_options',
...
$wp_customize->add_control(
	new businessbiz_Dropdown_Taxonomies_Control( $wp_customize, 'theme_options[feature_category]',
		array(
		'label'    => __( 'Select Category', 'businessbiz' ),
		'section'  => 'section_home_features',
		'settings' => 'theme_options[feature_category]',	
		'active_callback' => 'businessbiz_features_active',		
		'priority' => 100,
		)
	)
